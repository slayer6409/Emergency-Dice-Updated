    ...
    public class RustyDie : DieBehaviour
    {
        ...
        public override void Roll()
        {
            ...
            if(randomEffect == null) 
            {
                ...
                {
                    case 3:
                        MysteryDice.CustomLogger.LogDebug("Rolling Effect: Rusty 3");
                        ...
                        break;
                    case 4:
                        MysteryDice.CustomLogger.LogDebug("Rolling Effect: Rusty 4");
                        ...
                        break;
                    case 5:
                        MysteryDice.CustomLogger.LogDebug("Rolling Effect: Rusty 5");
                    ...
                    case 6:
                        ...
                        {
                            case 1:
                                MysteryDice.CustomLogger.LogDebug("Rolling Effect: Rusty 6 Eggs");
                                ...
                                break;
                            case 2:
                                MysteryDice.CustomLogger.LogDebug("Rolling Effect: Rusty 6 Christmas");
                                ...
                                break;
                            case 3:
                                MysteryDice.CustomLogger.LogDebug("Rolling Effect: Rusty 6 SSDD");
                                ...
                                break;
                            default:
                                MysteryDice.CustomLogger.LogDebug("Rolling Effect: Rusty 6 Normal");
