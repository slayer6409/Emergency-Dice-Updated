...
{
    internal class TpOverflowOutside : IEffect
    {
        public string Name => "TP overflow outside";
        public static int MinMinesToSpawn = 10;
        public static int MaxMinesToSpawn = 25;

        private static List<Vector3> allPositions = new List<Vector3>();
        public EffectType Outcome => EffectType.Awful;
        public bool ShowDefaultTooltip => true;
        public string Tooltip => "TP Traps spawned outside!";
        public void Use()
        {
            Networker.Instance.TPOverflowOutsideServerRPC();
        }

        public static void SpawnTPOutside(int MinesToSpawn, float positionOffsetRadius = 5f)
        {
            int spawnedMines = 0;
