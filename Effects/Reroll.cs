...
namespace MysteryDice.Effects
{
    internal class Reroll : IEffect
    {
        ...
        public void Use()
        {
            Networker.Instance.RerollServerRPC(GameNetworkManager.Instance.localPlayerController.playerClientId, UnityEngine.Random.Range(0, MysteryDice.RegisteredDice.Count()));
        }
        public static void DiceScrap(ulong userID, int dice)
        {
