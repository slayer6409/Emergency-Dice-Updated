...
namespace MysteryDice.Effects
{
    internal class MovingLandmines : IEffect
    {
        ...
        //     void Start()
        //     {
        //         _ainodes = GameObject.FindGameObjectsWithTag("OutsideAINode");
        //         path = new NavMeshPath();
        //     }
        //
        //     public void FixedUpdate()
        //     {
        //         if (!mapObject.gameObject.activeSelf)
        //         {
        //             Destroy(this);
        //             return;
        //         }
        ...
        //                 TargetPosition = _ainodes[UnityEngine.Random.Range(0, _ainodes.Length)].transform.position;
        //                 CalculateNewPath();
        //                 MoveSpeed = UnityEngine.Random.Range(3f, 7f);
        //                 Networker.Instance.SyncTrapClientRPC(mapObject.GetComponent<NetworkObject>().NetworkObjectId,
        //                     MoveSpeed, transform.position, TargetPosition, BlockedID);
        //             }
        //         }
        //
        ...
        //                     CalculateNewPath();
        //                     MoveSpeed = UnityEngine.Random.Range(3f, 7f);
        //                     Networker.Instance.SyncDataClientRPC(LandmineScr.NetworkObjectId, MoveSpeed,
        //                         transform.position, TargetPosition, BlockedID);
        //                 }
        //             }
        //
        //             if (paths.Length == 0) return;
        ...
        //             {
        //                 Landmine.SpawnExplosion(transform.position, true, 0, 0, 0, 0, null, false);
