...
{
    internal class SpikeOverflowOutside : IEffect
    {
        public string Name => "Spike overflow outside";
        ...
        public string Tooltip => "Spike Traps spawned outside!";
        public void Use()
        {
            Networker.Instance.SpikeOverflowOutsideServerRPC();
        }

        public static void SpawnSpikeOutside(int MinesToSpawn, float positionOffsetRadius = 5f)
        {
            int spawnedMines = 0;
